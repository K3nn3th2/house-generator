...
// sets uniforms for the house which is to be generated by the geometry shader and draws the house.
...
int main() {
    ...
    glfwInit();
    // Create a window
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Parametric House Generator", nullptr, nullptr);
